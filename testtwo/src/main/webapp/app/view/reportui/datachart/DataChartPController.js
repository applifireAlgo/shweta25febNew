Ext.define('Testtwo.view.reportui.datachart.DataChartPController', {
	extend : 'Ext.app.ViewController',

	alias : 'controller.datachartpController',
	requires : [ 'Testtwo.view.reportui.ModifiedProxy' ],
	queryCriteria : null,
	reportView : null,
