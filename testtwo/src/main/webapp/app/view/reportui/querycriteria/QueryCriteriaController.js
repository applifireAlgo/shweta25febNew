Ext.define('Testtwo.view.reportui.querycriteria.QueryCriteriaController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.querycriteriaController',
	requires : [ 'Testtwo.view.fw.DateRange' ],
	reportView : null,
	...
	loadData : function(reportJSON)
	{
		...
		var qcInnerPanel=this.getView().down('#qcInnerPanelId');
		qcInnerPanel.add(reportJSON.queryCWidgetU);
