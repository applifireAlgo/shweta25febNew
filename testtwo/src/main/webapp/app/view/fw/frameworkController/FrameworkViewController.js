Ext.define('Testtwo.view.fw.frameworkController.FrameworkViewController', {
    ...
    onConsoleClick: function() {
         var window = Ext.create('Testtwo.view.console.ConsoleWindow');
     ...
     createWindow : function (component){
		...
		modifyComponents : function(configData, view){
			...
			var xtype = items[index].xtype;
				...
				} else if(xtype == 'customradiogroup') {
