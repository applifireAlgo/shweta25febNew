 ...
 */
Ext.define('Testtwo.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Testtwo.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Testtwo.view.fw.component.DateTimePicker(o);
    },
