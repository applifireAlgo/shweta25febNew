 ...
 */
Ext.define('Testtwo.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Testtwo.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Testtwo.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Testtwo.view.login.SessionLogin').center();
