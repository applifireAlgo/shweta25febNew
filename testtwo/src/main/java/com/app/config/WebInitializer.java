...
public class WebInitializer implements WebApplicationInitializer {
    ...
    public String getSolrHomeDir(ServletContext servletContext) {
        ...
        String solrHomeDir = SOLR_HOME;
        if (appConfiguration.getSearchEngineConfig().getBasePath() != null && appConfiguration.getSearchEngineConfig().getBasePath().length() > 0) {
            solrHomeDir = appConfiguration.getSearchEngineConfig() != null && appConfiguration.getSearchEngineConfig().getBasePath() != null && appConfiguration.getSearchEngineConfig().getBasePath().length() > 0 ? appConfiguration.getSearchEngineConfig().getBasePath() : SOLR_HOME;
        }
        return solrHomeDir;
    }
    ...
    public String getSolrHome() {
        return "/home/applifire/workspace/VIUIKO0CGBTJWXZORYMJGA/testtwoSolr-4.9.0";
    }
