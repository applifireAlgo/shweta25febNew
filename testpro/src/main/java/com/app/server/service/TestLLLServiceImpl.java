...
import com.app.server.repository.TestLLLRepository;
...
@SourceCodeAuthorClass(createdBy = "nayan.chaudhari@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Service for TestLLL Master table Entity", complexity = Complexity.LOW)
@RequestMapping("/TestLLL")
public class TestLLLServiceImpl extends TestLLLService {
    ...
    @Autowired
    private TestLLLRepository<TestLLL> testLLLrepo;
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.defaultdomain.TestLLL> lsttestlll = testLLLrepo.findAll();
        responseBean.add("success", true);
        responseBean.add("message", "Successfully retrived ");
        responseBean.add("data", lsttestlll);
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, httpStatus);
    }

    @RequestMapping(consumes = "application/json", method = RequestMethod.POST)
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody TestLLL entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            testLLLrepo.save(entity);
            responseBean.add("success", true);
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody List<TestLLL> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            testLLLrepo.save(entity);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody TestLLL entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            testLLLrepo.update(entity);
            responseBean.add("success", true);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody List<TestLLL> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            testLLLrepo.update(entity);
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.defaultdomain.TestLLL lsttestlll = testLLLrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lsttestlll);
        } catch (org.springframework.transaction.TransactionException e) {
