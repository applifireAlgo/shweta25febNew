...
import com.app.server.repository.NewEntityRepository;
...
public class NewEntityServiceImpl extends NewEntityService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.defaultdomain.NewEntity> lstnewentity = newEntityrepo.findAll();
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody NewEntity entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody List<NewEntity> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            newEntityrepo.save(entity);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody NewEntity entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody List<NewEntity> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            newEntityrepo.update(entity);
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.defaultdomain.NewEntity lstnewentity = newEntityrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstnewentity);
        } catch (org.springframework.transaction.TransactionException e) {
