Ext.define('Testpro.testpro.web.com.controller.defaultcontext.defaultdomain.TestnnnnMainController', {
     extend: 'Testpro.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.TestnnnnMainController',
     init: function() {
          var form = this.view.down('#TestnnnnForm');
     ...
     addressLoad: function() {
          ...
          Ext.Ajax.request({
               ...
               success: function(response, scope) {
                    var compRef = scope.sender.down('#address');
                    scope.sender.controller.assignAllComboData(scope.sender, 'address', response.responseText);
     ...
     renderTreeGridData: function(responseData) {
          ...
          if (responseData.response.success) {
               ...
               var tree = this.view.down('#TestnnnnTree');
               ...
               var compRef = this.view.down('#TestnnnnTree');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#Testnnnn');
          var grid = this.view.down('#TestnnnnGrid');
          var tree = this.view.down('#TestnnnnTreeContainer');
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#TestnnnnForm');
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, currentObject) {
                    ...
                    var compRef = scope.sender.view.down('#TestnnnnTree');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          ...
          if (record.data.leaf) {
               var Testnnnn = this.view.down('#TestnnnnForm');
               Testnnnn.reset();
               var gridPanel = this.view.down('#TestnnnnGrid');
          ...
          var formPanel = this.getView().up().down('#TestnnnnForm');
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#TestnnnnTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#Testnnnn').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#TestnnnnGrid').store;
          gridStore.removeAll();
          gridStore.add(data);
     ...
     loadData: function(responseData) {
          this.view.down('#TestnnnnForm').getViewModel().setData(responseData.response.data);
     },
