Ext.define('Testpro.testpro.web.com.controller.defaultcontext.defaultdomain.TestOOOMainController', {
     extend: 'Testpro.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.TestOOOMainController',
     init: function() {
          var form = this.view.down('#TestOOOForm');
     ...
     renderTreeGridData: function(responseData) {
          ...
          if (responseData.response.success) {
               ...
               var tree = this.view.down('#TestOOOTree');
               ...
               var compRef = this.view.down('#TestOOOTree');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#TestOOO');
          var grid = this.view.down('#TestOOOGrid');
          var tree = this.view.down('#TestOOOTreeContainer');
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#TestOOOForm');
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, currentObject) {
                    ...
                    var compRef = scope.sender.view.down('#TestOOOTree');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          ...
          if (record.data.leaf) {
               var TestOOO = this.view.down('#TestOOOForm');
               TestOOO.reset();
               var gridPanel = this.view.down('#TestOOOGrid');
          ...
          var formPanel = this.getView().up().down('#TestOOOForm');
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#TestOOOTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#TestOOO').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#TestOOOGrid').store;
          gridStore.removeAll();
          gridStore.add(data);
     ...
     loadData: function(responseData) {
          this.view.down('#TestOOOForm').getViewModel().setData(responseData.response.data);
     },
